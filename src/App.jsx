...
export default function App() {
      ...
      <div className="flex flex-col items-center justify-center pb-10 h-full">
        ...
        <div className="flex flex-col items-center justify-start"> {/* Add 'justify-start' class */}
          ...
          <div className='bg-black bg-opacity-50 rounded-2xl shadow-lg px-5 mt-0 mb-5'>
            ...
            <div className=''>
              <PlayerGuess
                key={playerGuessKey} // Pass the key as a prop
  ...
  setIsBothPlayerAnswersCorrect(null); // Reset isBothPlayerAnswersCorrect
  setGlobalTournamentAnswer(null); // Reset GlobalTournamentAnswer
}}>Get New Index</button>
      </div>
    </div>
  );
